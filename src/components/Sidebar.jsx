...
export const NAV = [
  ...
  { key: 'places', label: '장소 관리', tier: 'P0', icon: 'M3 6l6-3 6 3 6-3v15l-6 3-6-3-6 3zM9 3v15M15 6v15' },
  ...
  { key: 'review', label: '사용자 코스 검수', tier: 'P1', icon: 'M9 12l2 2 4-4M4 4h16v16H4z' }
];
